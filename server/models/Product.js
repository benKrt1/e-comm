...
export const PRODUCT_CATEGORIES = ['audio', 'keyboards', 'smart-home', 'desk', 'wearables', 'accessories'];
...
const productSchema = new mongoose.Schema(
  {
    ...
    images: {
      type: [imageSchema],
      validate: { validator: (arr) => arr.length > 0, message: 'At least one image is required' },
    },
