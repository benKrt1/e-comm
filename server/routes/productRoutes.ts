...
import { SORT_OPTIONS, MAX_PAGE_SIZE } from '../utils/queryFeatures.ts';
...
router.get('/:slug', [param('slug').isSlug().withMessage('Invalid product slug')], validate, getProductBySlug);
