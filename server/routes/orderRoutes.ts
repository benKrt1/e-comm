...
import { createPaymentIntent, createOrder, getMyOrders, getOrderById } from '../controllers/orderController.ts';
...
router.post(
  '/',
  [
    body('paymentIntentId').isString().matches(/^pi_\w{1,200}$/).withMessage('Invalid payment reference'),
